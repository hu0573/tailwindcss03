function SiteBanner() {
  return (
    <main className="mt-10 md:mt-15 lg:mt-20 mx-auto max-w-7xl px-8">
      <div className="text-center sm:text-left">
        ...
        <p className="text-gray-500 mt-5 text-base md:text-xl">
        ...
        <div className="flex mt-5 w-auto justify-center sm:justify-start flex-col sm:flex-row">
          <div className="m-5">
